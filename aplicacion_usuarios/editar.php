<?php
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $query = $conn->prepare("UPDATE clientes SET nombre = :nombre, correo = :correo, telefono = :telefono, direccion = :direccion WHERE id = :id");
  ...
  //Fin de operacion update del crud
?>
        ...
        <main class = "container">
            ...
            <form action = "" method = "post">
                ...
                <div class="mb-3">
                    ...
                    placeholder="Digite la direccion donde vive" required/>
                </div>
